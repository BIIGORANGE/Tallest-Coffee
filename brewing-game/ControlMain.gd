...
@onready var fruits_label: Label = $Fruits
@onready var floors_counter: Label = $FloorsCounter
...
var brew_multiplier_perm = 0
var upgrade_cost = 10.0
var fruit_upgrade_cost = 1
var auto_brewers = 0
var auto_brewer_perm = 0
var ui_visiblity = true
